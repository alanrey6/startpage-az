...
// dark mode toggle set to the #dark id on the moon icon from font awesome
...
const enableDarkMode = () => {
    ...
    document.getElementsByTagName('nav')[0].style.background = 'var(--dark-middle-color)';
    ...
    document.getElementsByTagName('label')[0].style.color = 'var(--primary-color)';
...
const disableDarkMode = () => {
    ...
    document.getElementsByTagName('nav')[0].style.background = 'var(--light-middle-color)';
    ...
    document.getElementsByTagName('label')[0].style.color = 'var(--secondary-color)';
