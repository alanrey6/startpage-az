  ...
  try {
    ...
    const markup = `
      <ul>
        ...
        <li>${weatherIcon(data.current.weather[0].main)} ${
      ...
      <ul>
        ...
        <li>${weatherIcon(data.daily[1].weather[0].main)} ${
...
const weatherIcon = function (main) {
